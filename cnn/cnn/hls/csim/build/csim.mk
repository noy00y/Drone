...
HLS_SOURCES = ../../../../../hls_files/testbench.cpp ../../../../../hls_files/conv_pool.cpp
...
$(ObjDir)/testbench.o: ../../../../../hls_files/testbench.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../hls_files/testbench.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/testbench.d

$(ObjDir)/conv_pool.o: ../../../../../hls_files/conv_pool.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../hls_files/conv_pool.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/conv_pool.d
