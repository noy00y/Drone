...
set portList { 
	...
	{ m_axi_IMGmem_0_WDATA sc_out sc_lv 16 signal 1 } 
	{ m_axi_IMGmem_0_WSTRB sc_out sc_lv 2 signal 1 } 
	...
	{ m_axi_IMGmem_0_RDATA sc_in sc_lv 16 signal 1 } 
	{ m_axi_IMGmem_0_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_IMGmem_0_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_IMGmem_0_RFIFONUM sc_in sc_lv 10 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_IMGmem_0_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "IMGmem", "role": "0_WDATA" }} , 
 	{ "name": "m_axi_IMGmem_0_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "IMGmem", "role": "0_WSTRB" }} , 
 	...
 	{ "name": "m_axi_IMGmem_0_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "IMGmem", "role": "0_RDATA" }} , 
 	...
 	{ "name": "m_axi_IMGmem_0_RFIFONUM", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "IMGmem", "role": "0_RFIFONUM" }} , 
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "2", "Max" : "7337000"}
]}
...
set Spec2ImplPortList { 
	ctrl { ap_none {  { ctrl in_data 0 32 } } }
	 { m_axi {  { m_axi_IMGmem_0_AWVALID VALID 1 1 }  { m_axi_IMGmem_0_AWREADY READY 0 1 }  { m_axi_IMGmem_0_AWADDR ADDR 1 64 }  { m_axi_IMGmem_0_AWID ID 1 1 }  { m_axi_IMGmem_0_AWLEN SIZE 1 32 }  { m_axi_IMGmem_0_AWSIZE BURST 1 3 }  { m_axi_IMGmem_0_AWBURST LOCK 1 2 }  { m_axi_IMGmem_0_AWLOCK CACHE 1 2 }  { m_axi_IMGmem_0_AWCACHE PROT 1 4 }  { m_axi_IMGmem_0_AWPROT QOS 1 3 }  { m_axi_IMGmem_0_AWQOS REGION 1 4 }  { m_axi_IMGmem_0_AWREGION USER 1 4 }  { m_axi_IMGmem_0_AWUSER DATA 1 1 }  { m_axi_IMGmem_0_WVALID VALID 1 1 }  { m_axi_IMGmem_0_WREADY READY 0 1 }  { m_axi_IMGmem_0_WDATA FIFONUM 1 16 }  { m_axi_IMGmem_0_WSTRB STRB 1 2 }  { m_axi_IMGmem_0_WLAST LAST 1 1 }  { m_axi_IMGmem_0_WID ID 1 1 }  { m_axi_IMGmem_0_WUSER DATA 1 1 }  { m_axi_IMGmem_0_ARVALID VALID 1 1 }  { m_axi_IMGmem_0_ARREADY READY 0 1 }  { m_axi_IMGmem_0_ARADDR ADDR 1 64 }  { m_axi_IMGmem_0_ARID ID 1 1 }  { m_axi_IMGmem_0_ARLEN SIZE 1 32 }  { m_axi_IMGmem_0_ARSIZE BURST 1 3 }  { m_axi_IMGmem_0_ARBURST LOCK 1 2 }  { m_axi_IMGmem_0_ARLOCK CACHE 1 2 }  { m_axi_IMGmem_0_ARCACHE PROT 1 4 }  { m_axi_IMGmem_0_ARPROT QOS 1 3 }  { m_axi_IMGmem_0_ARQOS REGION 1 4 }  { m_axi_IMGmem_0_ARREGION USER 1 4 }  { m_axi_IMGmem_0_ARUSER DATA 1 1 }  { m_axi_IMGmem_0_RVALID VALID 0 1 }  { m_axi_IMGmem_0_RREADY READY 1 1 }  { m_axi_IMGmem_0_RDATA FIFONUM 0 16 }  { m_axi_IMGmem_0_RLAST LAST 0 1 }  { m_axi_IMGmem_0_RID ID 0 1 }  { m_axi_IMGmem_0_RFIFONUM LEN 0 10 }  { m_axi_IMGmem_0_RUSER DATA 0 1 }  { m_axi_IMGmem_0_RRESP RESP 0 2 }  { m_axi_IMGmem_0_BVALID VALID 0 1 }  { m_axi_IMGmem_0_BREADY READY 1 1 }  { m_axi_IMGmem_0_BRESP RESP 0 2 }  { m_axi_IMGmem_0_BID ID 0 1 }  { m_axi_IMGmem_0_BUSER DATA 0 1 } } }
