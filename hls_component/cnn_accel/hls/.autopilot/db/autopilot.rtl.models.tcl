set SynModuleInfo {
  {SRCNAME load_img MODELNAME load_img RTLNAME cnn_accel_load_img
    SUBMODULES {
      {MODELNAME cnn_accel_flow_control_loop_delay_pipe RTLNAME cnn_accel_flow_control_loop_delay_pipe BINDTYPE interface TYPE internal_upc_flow_control INSTNAME cnn_accel_flow_control_loop_delay_pipe_U}
    }
  }
  {SRCNAME conv1 MODELNAME conv1 RTLNAME cnn_accel_conv1
    SUBMODULES {
      ...
      {MODELNAME cnn_accel_flow_control_loop_pipe RTLNAME cnn_accel_flow_control_loop_pipe BINDTYPE interface TYPE internal_upc_flow_control INSTNAME cnn_accel_flow_control_loop_pipe_U}
    }
  }
  ...
  {SRCNAME cnn_accel MODELNAME cnn_accel RTLNAME cnn_accel IS_TOP 1
    SUBMODULES {
      {MODELNAME cnn_accel_local_img_RAM_AUTO_1R1W_memcore RTLNAME cnn_accel_local_img_RAM_AUTO_1R1W_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME cnn_accel_feat1_RAM_AUTO_1R1W_memcore RTLNAME cnn_accel_feat1_RAM_AUTO_1R1W_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME cnn_accel_feat1_p_RAM_AUTO_1R1W_memcore RTLNAME cnn_accel_feat1_p_RAM_AUTO_1R1W_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME cnn_accel_feat2_RAM_AUTO_1R1W_memcore RTLNAME cnn_accel_feat2_RAM_AUTO_1R1W_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME cnn_accel_feat2_p_RAM_AUTO_1R1W_memcore RTLNAME cnn_accel_feat2_p_RAM_AUTO_1R1W_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME cnn_accel_vec1_RAM_AUTO_1R1W_memcore RTLNAME cnn_accel_vec1_RAM_AUTO_1R1W_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME cnn_accel_vec2_RAM_AUTO_1R1W_memcore RTLNAME cnn_accel_vec2_RAM_AUTO_1R1W_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
