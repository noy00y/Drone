...
set C_modelArgList {
	{ IMGmem int 16 regular {axi_master 0}  }
	{ W1mem int 16 unused {axi_master 0}  }
	{ B1mem int 16 unused {axi_master 0}  }
	{ W2mem int 16 unused {axi_master 0}  }
	{ B2mem int 16 unused {axi_master 0}  }
	{ W3mem int 16 unused {axi_master 0}  }
	{ B3mem int 16 unused {axi_master 0}  }
	{ W4mem int 16 unused {axi_master 0}  }
	{ B4mem int 16 unused {axi_master 0}  }
	{ Foutmem int 8 regular {axi_master 1}  }
	{ img_in int 64 regular {axi_slave 0}  }
	{ weights1 int 64 unused {axi_slave 0}  }
	{ bias1 int 64 unused {axi_slave 0}  }
	{ weights2 int 64 unused {axi_slave 0}  }
	{ bias2 int 64 unused {axi_slave 0}  }
	{ FC1_W int 64 unused {axi_slave 0}  }
	{ FC1_B int 64 unused {axi_slave 0}  }
	{ FC2_W int 64 unused {axi_slave 0}  }
	{ FC2_B int 64 unused {axi_slave 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "IMGmem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "img_in","offset": { "type": "dynamic","port_name": "img_in","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "W1mem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "weights1","offset": { "type": "dynamic","port_name": "weights1","bundle": "control"}}]}]} , 
 	{ "Name" : "B1mem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "bias1","offset": { "type": "dynamic","port_name": "bias1","bundle": "control"}}]}]} , 
 	{ "Name" : "W2mem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "weights2","offset": { "type": "dynamic","port_name": "weights2","bundle": "control"}}]}]} , 
 	{ "Name" : "B2mem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "bias2","offset": { "type": "dynamic","port_name": "bias2","bundle": "control"}}]}]} , 
 	{ "Name" : "W3mem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "FC1_W","offset": { "type": "dynamic","port_name": "FC1_W","bundle": "control"}}]}]} , 
 	{ "Name" : "B3mem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "FC1_B","offset": { "type": "dynamic","port_name": "FC1_B","bundle": "control"}}]}]} , 
 	{ "Name" : "W4mem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "FC2_W","offset": { "type": "dynamic","port_name": "FC2_W","bundle": "control"}}]}]} , 
 	{ "Name" : "B4mem", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "FC2_B","offset": { "type": "dynamic","port_name": "FC2_B","bundle": "control"}}]}]} , 
...
set ArgLastReadFirstWriteLatency {
	cnn_accel {
		...
		B4mem {Type I LastRead -1 FirstWrite -1}
		Foutmem {Type O LastRead 2 FirstWrite 1}
		...
		buf_r {Type IO LastRead -1 FirstWrite -1}}
	Block_entry_proc {
		ctrl {Type I LastRead 0 FirstWrite -1}
		IMGmem {Type I LastRead 1 FirstWrite -1}
	...
	stream_img {
		IMGmem {Type I LastRead 1 FirstWrite -1}
		img_in {Type I LastRead 0 FirstWrite -1}
		img_strm {Type O LastRead -1 FirstWrite 2}}
	stream_img_Pipeline_VITIS_LOOP_35_1 {
		IMGmem {Type I LastRead 1 FirstWrite -1}
	...
	fc2 {
		...
		flag_out {Type I LastRead 0 FirstWrite -1}}
	conv1_stream {
		img_strm {Type I LastRead 1 FirstWrite -1}
		feat1_strm {Type O LastRead -1 FirstWrite 1}}
	conv1_stream_Pipeline_PIX_CH {
		img_strm {Type I LastRead 1 FirstWrite -1}}
	conv1_stream_Pipeline_VITIS_LOOP_82_4 {
		feat1_strm {Type O LastRead -1 FirstWrite 1}}
	pool1_stream {
		feat1_strm {Type I LastRead 2 FirstWrite -1}
		feat1_p_strm {Type O LastRead -1 FirstWrite 6}
		buf_1 {Type IO LastRead -1 FirstWrite -1}}
	conv2_stream {
		feat1_p_strm {Type I LastRead 1 FirstWrite -1}
		feat2_strm {Type O LastRead -1 FirstWrite 1}}
	conv2_stream_Pipeline_CH2 {
		feat1_p_strm {Type I LastRead 1 FirstWrite -1}}
	conv2_stream_Pipeline_VITIS_LOOP_158_4 {
		feat2_strm {Type O LastRead -1 FirstWrite 1}}
	pool2_stream {
		feat2_strm {Type I LastRead 2 FirstWrite -1}
		feat2_p_strm {Type O LastRead -1 FirstWrite 6}
		buf_r {Type IO LastRead -1 FirstWrite -1}}
	flatten_stream {
		feat2_p_strm {Type I LastRead 1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "7337000"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "7337001"}
]}
