set moduleName cnn_accel_Pipeline_FC2_LOOP
set isTopModule 0
...
set cdfgNum 13
set C_modelName {cnn_accel_Pipeline_FC2_LOOP}
...
set C_modelArgMapList {[ 
	{ "Name" : "acc2", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln212", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln212 sc_in sc_lv 62 signal 2 } 
	{ acc2_1_out sc_out sc_lv 32 signal 3 } 
	{ acc2_1_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln212", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln212", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln212 { ap_none {  { sext_ln212 in_data 0 62 } } }
