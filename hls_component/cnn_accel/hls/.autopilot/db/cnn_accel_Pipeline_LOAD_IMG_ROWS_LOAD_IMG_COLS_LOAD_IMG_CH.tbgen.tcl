set moduleName cnn_accel_Pipeline_LOAD_IMG_ROWS_LOAD_IMG_COLS_LOAD_IMG_CH
set isTopModule 0
...
set cdfgNum 13
set C_modelName {cnn_accel_Pipeline_LOAD_IMG_ROWS_LOAD_IMG_COLS_LOAD_IMG_CH}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_img { MEM_WIDTH 32 MEM_SIZE 307200 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict local_img_1 { MEM_WIDTH 32 MEM_SIZE 307200 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict local_img_2 { MEM_WIDTH 32 MEM_SIZE 307200 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln85 int 62 regular  }
	{ local_img float 32 regular {array 76800 { 0 3 } 0 1 } {global 1}  }
	{ local_img_1 float 32 regular {array 76800 { 0 3 } 0 1 } {global 1}  }
	{ local_img_2 float 32 regular {array 76800 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "img_in","offset": { "type": "dynamic","port_name": "img_in","bundle": "control"},"direction": "READONLY"},{"cName": "weights1","offset": { "type": "dynamic","port_name": "weights1","bundle": "control"},"direction": "READONLY"},{"cName": "bias1","offset": { "type": "dynamic","port_name": "bias1","bundle": "control"},"direction": "READONLY"},{"cName": "weights2","offset": { "type": "dynamic","port_name": "weights2","bundle": "control"},"direction": "READONLY"},{"cName": "bias2","offset": { "type": "dynamic","port_name": "bias2","bundle": "control"},"direction": "READONLY"},{"cName": "FC1_W","offset": { "type": "dynamic","port_name": "FC1_W","bundle": "control"},"direction": "READONLY"},{"cName": "FC1_B","offset": { "type": "dynamic","port_name": "FC1_B","bundle": "control"},"direction": "READONLY"},{"cName": "FC2_W","offset": { "type": "dynamic","port_name": "FC2_W","bundle": "control"},"direction": "READONLY"},{"cName": "FC2_B","offset": { "type": "dynamic","port_name": "FC2_B","bundle": "control"},"direction": "READONLY"},{"cName": "flag_out","offset": { "type": "dynamic","port_name": "flag_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "local_img_2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ sext_ln85 sc_in sc_lv 62 signal 1 } 
	{ local_img_address0 sc_out sc_lv 17 signal 2 } 
	{ local_img_ce0 sc_out sc_logic 1 signal 2 } 
	{ local_img_we0 sc_out sc_logic 1 signal 2 } 
	{ local_img_d0 sc_out sc_lv 32 signal 2 } 
	{ local_img_1_address0 sc_out sc_lv 17 signal 3 } 
	...
	{ local_img_2_address0 sc_out sc_lv 17 signal 4 } 
	{ local_img_2_ce0 sc_out sc_logic 1 signal 4 } 
	{ local_img_2_we0 sc_out sc_logic 1 signal 4 } 
	{ local_img_2_d0 sc_out sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_img_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "local_img", "role": "address0" }} , 
 	...
 	{ "name": "local_img_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "local_img_1", "role": "address0" }} , 
 	...
 	{ "name": "local_img_2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "local_img_2", "role": "address0" }} , 
 	{ "name": "local_img_2_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_img_2", "role": "ce0" }} , 
 	{ "name": "local_img_2_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_img_2", "role": "we0" }} , 
 	{ "name": "local_img_2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "local_img_2", "role": "d0" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "230403", "Max" : "230403"}
	, {"Name" : "Interval", "Min" : "230403", "Max" : "230403"}
]}
...
set Spec2ImplPortList { 
	...
	local_img { ap_memory {  { local_img_address0 mem_address 1 17 }  { local_img_ce0 mem_ce 1 1 }  { local_img_we0 mem_we 1 1 }  { local_img_d0 mem_din 1 32 } } }
	local_img_1 { ap_memory {  { local_img_1_address0 mem_address 1 17 }  { local_img_1_ce0 mem_ce 1 1 }  { local_img_1_we0 mem_we 1 1 }  { local_img_1_d0 mem_din 1 32 } } }
	local_img_2 { ap_memory {  { local_img_2_address0 mem_address 1 17 }  { local_img_2_ce0 mem_ce 1 1 }  { local_img_2_we0 mem_we 1 1 }  { local_img_2_d0 mem_din 1 32 } } }
}
