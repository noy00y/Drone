...
REM
REM Generated by Vivado on Sun Aug 03 17:31:41 -0700 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_conv_PE_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_conv_PE_vlog.prj -log xvlog.log
